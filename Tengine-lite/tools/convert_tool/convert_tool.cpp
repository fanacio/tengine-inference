...
int main(int argc, char* argv[])
{
    ...
    //新增调试：用于caffe框架转tmfile的shoot模型
    //以下代码用于调试使用，不调试则注释掉
    // file_format = "caffe";  //-f
    // model_file = "/home/Tengine-tengine-lite-20211208/models/shootmodelv2.caffemodel";           //-m
    // proto_file = "/home/Tengine-tengine-lite-20211208/models/shootmodelv2.prototxt";           //-p
    // output_tmfile = "/home/Tengine-tengine-lite-20211208/models/shootmodelv2_v2.0.tmfile";//-o
